...
public interface GroupMapper {
    ...
    Group groupFromCreateRequest(GroupCreateRequest request, Admission admission, Level level);
    ...
    @Mapping(target = "level", source = "level")
    @Mapping(target = "branchId", source = "request.branchId")
    Group groupFromUpdateRequest(GroupUpdateRequest request, Admission admission, Level level);
