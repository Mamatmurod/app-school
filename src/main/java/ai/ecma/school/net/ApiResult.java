...
public class ApiResult<T> implements Serializable {
    ...
    public static ApiResult<ErrorData> errorResponse(String errorMsg, HttpStatus httpStatus) {
        return new ApiResult<>(errorMsg, httpStatus.value());
    }
    ...
    public <X extends Throwable> void noMemberThrow(Supplier<? extends X> exception) throws X {
        if (!hasMember) throw exception.get();
    }
